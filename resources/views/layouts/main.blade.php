...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lora:400,400i,700,700i|Montserrat:400,500,700|Playfair+Display:400,400i,700,700i&amp;subset=cyrillic"
          rel="stylesheet">
    <link href="{{env('APP_URL')}}css/style.css?213223" rel="stylesheet" media="screen">
</head>
<body>
<!-- SCRIPTS -->
<div id="app">
...
<script src="{{env('APP_URL')}}js/app.js?121223"></script>
...
<script src="{{env('APP_URL')}}js/main.js?121123"></script>
